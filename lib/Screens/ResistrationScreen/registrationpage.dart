      ...
      body: SafeArea(
        ...
        contentPadding: EdgeInsets.symmetric(vertical: 15.h, horizontal: 16.w),
                        ...
                        focusedBorder:  OutlineInputBorder(
                            borderSide:
                                BorderSide(color: const Color(0xff1879492b).withOpacity(0.2),  width: 0.5)),
                        enabledBorder:  OutlineInputBorder(
                            borderSide:
                                BorderSide(color:const Color(0xFF1879492B).withOpacity(0.2), width: 0.5)),
                        border:  OutlineInputBorder(
                            borderSide:
                                BorderSide(color:const Color(0xFF1879492B).withOpacity(0.2),  width: 0)),
                        hintText: "*******",
                    //     suffixIcon: Obx(
                    //       () => InkWell(
                    //           onTap: () {
                    ...
                    TextFormField(
                     ...
                     contentPadding: EdgeInsets.symmetric(vertical: 15.h, horizontal: 16.w),
                        ...
                        focusedBorder:  OutlineInputBorder(
                            borderSide:
                                BorderSide(color: const Color(0xFF187949).withOpacity(0.2),  width: 0.5)),
                        enabledBorder:  OutlineInputBorder(
                            borderSide:
                                BorderSide(color:const Color(0xFF187949).withOpacity(0.2),  width: 0.5)),
                        border:  OutlineInputBorder(
                            borderSide:
                                BorderSide(color:const Color(0xFF187949).withOpacity(0.2),  width: 0)),
                        hintText: "*******",
                    //     suffixIcon: Obx(
                    //       () => InkWell(
                    //           onTap: () {
