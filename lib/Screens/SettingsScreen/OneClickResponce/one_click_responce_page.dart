          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 15,),
                Text('One Click Responce enabled', style: myStyle(18, FontWeight.w500, textClr),)
              ],
            ),
            SizedBox(height: 15,),
            Text('Email template to be used for your one-click response:', style: myStyle(14, FontWeight.w400, textClr),),
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(selectedValue!, style: myStyle(18, FontWeight.w500, textClr),),
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                            'Your one-click response will look like a personal email from you. Any replies to the email will be sent straight to you, meaning you ll hear back from more customers.', textAlign: TextAlign.center, style: myStyle(12, FontWeight.w400, textClr),),
                      ),
                    ],
                  ),
                  SizedBox(height: 15,),
                  ...
                  SizedBox(height: 20,),
                  Text('You can change your one-click response for future leads above', style: myStyle(12, FontWeight.w400, textClr),)
                ],
              ),
            ),
          ],
