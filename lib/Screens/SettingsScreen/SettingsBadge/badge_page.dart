                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Icon(Icons.circle, size: 6, color: textClr,),
                        ),
                        SizedBox(width: 5,),
                        Expanded(
                            child: Text(
                                'Upgrading your app with a ringknock badge helps boost search engine rankings (SEO) and attractsmore customers', style: myStyle(14, FontWeight.w400, textClr),))
                      ],
                    ),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Expanded(
                            child: Text(
                          'Visitors to your website will be able to see your reviews and leave their own. This increases customer trust, gaining you more business - for free', style: myStyle(14, FontWeight.w400, textClr),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            child: Text(
                                'Customers are much more likely to hire professionals with 1 or more badges on display',  style: myStyle(14, FontWeight.w400, textClr),))
                      ],
                    )
                  ],
                ),
