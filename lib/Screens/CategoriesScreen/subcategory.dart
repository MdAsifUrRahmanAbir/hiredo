                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: TextField(
                              ...
                              onChanged: (value) {
                                if (value.isEmpty) {
                                  _subCatController.demoList.value =
                                      _subCatController.subcategory;
                                }
                              },
                    ...
                    () => ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          LeadCategoriesModel data =
                              _subCatController.demoList[index];
                          return Container(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => IconButton(
                                    onPressed: () {
                                      _homeController
                                          .addAndRemoveWishList(data.id);
                                    },
                                    icon: _homeController.wishList
                                            .contains(data.id)
                                        ? Icon(
                                            Icons.favorite,
