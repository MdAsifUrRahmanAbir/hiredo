...
class SubCategoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     debugPrint(data);
    // List<LeadCategoriesModel> subcategory=data["subCategory"];
    // debugPrint(subcategory.toString());
    // _subCatController.demoList.value=data['name'];
    // _subCatController.subcategory.value=subcategory;
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
